...
import com.example.twoactivitiescodingchallenge.R;
...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int button_value = intent.getIntExtra(com.example.twoactivitiescodingchallenge.MainActivity.EXTRA_MESSAGE,0);
        if(button_value==1) {
